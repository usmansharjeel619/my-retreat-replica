...
const HeroSection = () => {
  const retreatDate = new Date('2025-04-24T15:00:00');
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-wide section-padding text-center">
        ...
        {/* Main Heading */}
        <h1 className="heading-xl mb-4 text-foreground animate-fade-in" style={{ animationDelay: '0.1s' }}>
          Luxury Couples<br />
          <span className="text-gradient">Reconnection Retreat</span>
        </h1>

        {/* Subheading */}
        <p className="body-lg text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          2 Nights, 3 Days of Restoration<br />
          <span className="font-medium text-foreground">All-Inclusive Experience</span>
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="flex items-center gap-2 bg-card px-4 py-2 rounded-full border border-border shadow-sm">
            ...
            <span className="text-sm font-medium">24–27 April 2025</span>
          </div>
          <div className="flex items-center gap-2 bg-card px-4 py-2 rounded-full border border-border shadow-sm">
        ...
        <div className="mb-10 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <p className="text-sm text-muted-foreground uppercase tracking-wider mb-4">Retreat Begins In</p>
        ...
        <div className="animate-fade-in" style={{ animationDelay: '0.5s' }}>
          ...
          <p className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-6">
            £2,000 <span className="text-lg font-normal text-muted-foreground">per couple</span>
          </p>
          <Button 
            size="lg" 
            ...
            asChild
          >
            <a href="#booking">Book Your Space</a>
          </Button>
        </div>
