...
const testimonials = [
  {
    ...
    quote:
      "I'd say Luxe Counselling Retreat literally 'saved the day' and because of that I am still in contact with individuals now. I respect what they are doing and will recommend others to reach out whether you're struggling with mental health or going through a hard time dealing with a difficult personal situation. 10/10. Keep it up!",
  },
  {
    ...
    quote:
      "I've attended several retreats in the past, but Luxe Retreats is on a whole different level. Rabi and his team bring unmatched creativity and intention to every detail, making the experience truly unique. Their care and dedication are second to none. If you're on the fence about going – take the leap. You won't regret it.",
  },
  {
    name: "Andrew",
    image:
    ...
    quote:
      "After dealing with some really hard issues throughout my life, the team at Luxe Retreat helped me on my path to resolving them and got me on my way to getting back to myself. Highly recommended for anyone in need of help.",
  },
  {
