...
const itinerary = [
  {
    ...
    activities: [
      ...
      { time: '4:30 PM', activity: 'Welcome to our Moroccan-Style Villa with Refreshments' },
      { time: '5:30 PM', activity: 'First Evening Welcome Dinner for Couples' },
      { time: '7:30 PM', activity: 'Traditional Moroccan Fire Dancing Show at the Villa' },
  ...
  },
  {
    ...
    activities: [
      ...
      { time: '12:00 PM', activity: 'Group Counselling Workshop "Healing Together"' },
      { time: '1:00 PM', activity: 'Reflection time for couples' },
      { time: '3:30 PM', activity: 'Magical Dinner Show & Camel Ride in Agafay Desert at sunset' },
  ...
  },
  {
    ...
    activities: [
      ...
      { time: '12:00 PM', activity: 'Nutrition Workshop (Mindful Eating & Shared Wellness)' },
      { time: '2:30 PM', activity: 'Lunch' },
      { time: '3:30 PM', activity: 'Poolside Relaxation & Connection Activities' },
      { time: '5:00 PM', activity: 'Couples Counselling Topic "The Art of Emotional Honesty"' },
  ...
  },
  {
    ...
    activities: [
      ...
      { time: '1:30 PM', activity: 'Topic of the Day "Rebuilding Trust After Pain"' },
  ...
  {
    day: 'Day 7',
    title: 'Beach Club & Games Night',
    activities: [
      { time: '8:00 AM', activity: 'Morning walk' },
      { time: '9:00 AM', activity: 'Swimming' },
      { time: '10:00 AM', activity: 'Breakfast' },
      { time: '11:30 AM', activity: 'Topic of the day' },
      { time: '1:00 PM', activity: 'Snacks' },
      { time: '2:00 PM', activity: 'Beach Club chill out with activities' },
      { time: '8:00 PM', activity: 'Attending Games Night' },
    ],
  },
  {
    day: 'Day 8',
    ...
    activities: [
      ...
      { time: '9:00 AM', activity: 'Reflection Workshop "Our Healing Journey & Future Together"' },
      { time: '10:30 AM', activity: 'Breakfast' },
