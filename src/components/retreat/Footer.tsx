      ...
      <div className="container-wide">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-serif font-semibold">Luxe Retreats</span>
          </div>

          {/* Links */}
          <nav className="flex flex-wrap justify-center gap-6 text-sm text-background/70">
            <a href="#itinerary" className="hover:text-primary transition-colors">Itinerary</a>
        ...
        <div className="border-t border-background/10 mt-8 pt-8 text-center text-sm text-background/50">
          <p>© {currentYear} Luxe Couples Reconnection Retreat. All rights reserved.</p>
